...
export default function SignInPage() {
  ...
  useEffect(() => {
    ...
    if (params.get("verified") === "true") setIsVerified(true);
    if (params.get("reset") === "true") setIsReset(true);
  }, []);
        ...
        <div className="bg-white dark:bg-slate-900/50 px-6 py-10 shadow-xl shadow-slate-200/50 dark:shadow-none ring-1 ring-slate-200 dark:ring-slate-800 rounded-3xl backdrop-blur-sm">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <span className="text-sm font-bold leading-6">Continue with Google</span>
            </button>
          ...
          <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
            {isVerified && (
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 rounded-2xl p-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-emerald-900 dark:text-emerald-100">Account Verified!</h3>
                    <p className="text-xs text-emerald-700 dark:text-emerald-300 font-medium mt-0.5">
                      Your account is ready. You can now sign in below.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {isReset && (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-2xl p-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-blue-900 dark:text-blue-100">Password Updated!</h3>
            ...
            <div>
              <div className="flex items-center justify-between ml-1">
                ...
                <div className="text-sm">
                  <Link href="/auth/forgot-password" className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400">
                    Forgot password?
                  </Link>
                </div>
              </div>
